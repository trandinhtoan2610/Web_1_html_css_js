    ...
    <h3>Thống kê sản phẩm</h3>
     <div class="table-TK">
            <div class="table-header">
                <div class="header__item"><p id="id" class="text_head" href="#">Tên sản phẩm</p></div>
                <div class="header__item"><p id="name" class="text_head" href="#">Thổng số lượng bán</p></div>
                <div class="header__item"><p id="price" class="text_head" href="#">Tổng số tiền bán</p></div>
               
		    </div>
            <div class="table-content" id="table-content" style ="max-height: 400px; overflow : auto;">
...
function displayTopCustomers(orders) {
  ...
  let customersHTML = `
    ...
    <h3>Top 5 khách hàng mua nhiều nhất</h3>
     <div class="table">
            <div class="table-header">
                <div class="header__item"><p id="id" class="text_head" href="#">Tên khách hàng</p></div>
                <div class="header__item"><p id="name" class="text_head" href="#">Tổng số tiền mà khách hàng đã mua</p></div>
                <div class="header__item"><p id="price" class="text_head text_head" href="#">Xem tất cả hóa đơn</p></div>
		    </div>
